...
export type Database = {
  ...
  public: {
    ...
    Functions: {
      ...
      backfill_client_user_ids: { Args: never; Returns: undefined }
      ...
      create_test_security_alert: { Args: never; Returns: string }
      ...
      ensure_professional_profile: { Args: never; Returns: undefined }
      ...
      generate_access_code: { Args: { p_name: string }; Returns: string }
      ...
      get_current_professional_id: { Args: never; Returns: string }
      get_current_user_type: { Args: never; Returns: string }
      get_current_user_type_safe: { Args: never; Returns: string }
