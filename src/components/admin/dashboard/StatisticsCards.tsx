...
export function StatisticsCards({
  ...
  return <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
      <Card>
        ...
        <CardContent>
          {isLoading ? <Skeleton className="h-7 w-20" /> : <div className="text-2xl font-bold">{userCount.toLocaleString()}</div>}
      ...
      <Card>
        ...
        <CardContent>
          {isLoading ? <Skeleton className="h-7 w-20" /> : <div className="text-2xl font-bold">24.3%</div>}
          <p className="text-xs text-muted-foreground">
