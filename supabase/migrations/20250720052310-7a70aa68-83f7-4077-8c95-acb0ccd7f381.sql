...
-- Insert default plan features with enhanced feature toggles
INSERT INTO public.plan_features (plan_id, feature_name, feature_value, is_enabled) VALUES
-- Free plan features
((SELECT id FROM public.subscription_plans WHERE name = 'free'), 'api_access', NULL, false),
((SELECT id FROM public.subscription_plans WHERE name = 'free'), 'crm_integrations', '[]', false),
((SELECT id FROM public.subscription_plans WHERE name = 'free'), 'iframe_embed', NULL, false),
((SELECT id FROM public.subscription_plans WHERE name = 'free'), 'white_label', NULL, false),
((SELECT id FROM public.subscription_plans WHERE name = 'free'), 'ai_lead_scoring', NULL, false),
((SELECT id FROM public.subscription_plans WHERE name = 'free'), 'custom_reports', NULL, false),
((SELECT id FROM public.subscription_plans WHERE name = 'free'), 'multi_user', NULL, false),
-- Professional plan features
((SELECT id FROM public.subscription_plans WHERE name = 'professional'), 'api_access', NULL, false),
((SELECT id FROM public.subscription_plans WHERE name = 'professional'), 'crm_integrations', '["hubspot"]', true),
((SELECT id FROM public.subscription_plans WHERE name = 'professional'), 'iframe_embed', NULL, true),
((SELECT id FROM public.subscription_plans WHERE name = 'professional'), 'white_label', NULL, false),
((SELECT id FROM public.subscription_plans WHERE name = 'professional'), 'ai_lead_scoring', NULL, true),
((SELECT id FROM public.subscription_plans WHERE name = 'professional'), 'custom_reports', NULL, true),
((SELECT id FROM public.subscription_plans WHERE name = 'professional'), 'multi_user', NULL, true),
-- Enterprise plan features
((SELECT id FROM public.subscription_plans WHERE name = 'enterprise'), 'api_access', NULL, true),
((SELECT id FROM public.subscription_plans WHERE name = 'enterprise'), 'crm_integrations', '["hubspot", "salesforce", "pipedrive"]', true),
((SELECT id FROM public.subscription_plans WHERE name = 'enterprise'), 'iframe_embed', NULL, true),
((SELECT id FROM public.subscription_plans WHERE name = 'enterprise'), 'white_label', NULL, true),
((SELECT id FROM public.subscription_plans WHERE name = 'enterprise'), 'ai_lead_scoring', NULL, true),
((SELECT id FROM public.subscription_plans WHERE name = 'enterprise'), 'custom_reports', NULL, true),
((SELECT id FROM public.subscription_plans WHERE name = 'enterprise'), 'multi_user', NULL, true);
