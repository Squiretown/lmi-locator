-- Fix legacy user deletion: corrected functions + CASCADE constraints

-- First, fix the diagnose_user_data function with proper column references
...
-- Now fix the delete_user_references function with proper error handling
...
-- This provides a failsafe in case the function misses anything

-- client_profiles -> professionals
ALTER TABLE client_profiles DROP CONSTRAINT IF EXISTS client_profiles_professional_id_fkey;
ALTER TABLE client_profiles ADD CONSTRAINT client_profiles_professional_id_fkey 
FOREIGN KEY (professional_id) REFERENCES professionals(id) ON DELETE CASCADE;

-- batch_search_jobs -> users
ALTER TABLE batch_search_jobs DROP CONSTRAINT IF EXISTS batch_search_jobs_user_id_fkey;
ALTER TABLE batch_search_jobs ADD CONSTRAINT batch_search_jobs_user_id_fkey 
FOREIGN KEY (user_id) REFERENCES auth.users(id) ON DELETE CASCADE;

-- census_tract_searches -> users  
ALTER TABLE census_tract_searches DROP CONSTRAINT IF EXISTS census_tract_searches_user_id_fkey;
...
-- data_import_log -> users
ALTER TABLE data_import_log DROP CONSTRAINT IF EXISTS data_import_log_user_id_fkey;
...
-- lmi_search_error_logs -> users
ALTER TABLE lmi_search_error_logs DROP CONSTRAINT IF EXISTS lmi_search_error_logs_user_id_fkey;
ALTER TABLE lmi_search_error_logs ADD CONSTRAINT lmi_search_error_logs_user_id_fkey 
FOREIGN KEY (user_id) REFERENCES auth.users(id) ON DELETE CASCADE;

-- saved_properties -> users
ALTER TABLE saved_properties DROP CONSTRAINT IF EXISTS saved_properties_user_id_fkey;
...
-- client_invitations -> professionals
ALTER TABLE client_invitations DROP CONSTRAINT IF EXISTS client_invitations_professional_id_fkey;
ALTER TABLE client_invitations ADD CONSTRAINT client_invitations_professional_id_fkey 
FOREIGN KEY (professional_id) REFERENCES professionals(id) ON DELETE CASCADE;

-- client_team_assignments -> professionals
ALTER TABLE client_team_assignments DROP CONSTRAINT IF EXISTS client_team_assignments_professional_id_fkey;
ALTER TABLE client_team_assignments ADD CONSTRAINT client_team_assignments_professional_id_fkey 
FOREIGN KEY (professional_id) REFERENCES professionals(id) ON DELETE CASCADE;

-- client_activity_logs -> professionals
ALTER TABLE client_activity_logs DROP CONSTRAINT IF EXISTS client_activity_logs_professional_id_fkey;
ALTER TABLE client_activity_logs ADD CONSTRAINT client_activity_logs_professional_id_fkey 
FOREIGN KEY (professional_id) REFERENCES professionals(id) ON DELETE CASCADE;

-- client_communications -> professionals
ALTER TABLE client_communications DROP CONSTRAINT IF EXISTS client_communications_professional_id_fkey;
...
ALTER TABLE clients DROP CONSTRAINT IF EXISTS clients_professional_id_fkey;
ALTER TABLE clients ADD CONSTRAINT clients_professional_id_fkey 
FOREIGN KEY (professional_id) REFERENCES professionals(id) ON DELETE CASCADE;

-- admin_error_logs -> users (admin_user_id)
ALTER TABLE admin_error_logs DROP CONSTRAINT IF EXISTS admin_error_logs_admin_user_id_fkey;
...
-- contact_interactions -> contacts (cascade through contacts -> professionals -> users)
ALTER TABLE contact_interactions DROP CONSTRAINT IF EXISTS contact_interactions_contact_id_fkey;
