-- Clean up orphaned records and fix legacy user deletion with proper constraint handling
...
-- Fix the diagnose_user_data function with proper column references
...
-- Drop and recreate CASCADE constraints properly
