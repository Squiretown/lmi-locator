-- Phase 1: Role System Cleanup Migration (Final Corrected Version)
...
-- 9. Update user_profiles to use standardized role names
UPDATE public.user_profiles 
SET user_type = 'mortgage_professional' 
WHERE user_type = 'mortgage_broker';

-- 10. Create triggers for automatic profile creation
