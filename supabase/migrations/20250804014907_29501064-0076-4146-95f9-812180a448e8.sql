-- Comprehensive Legacy User Deletion Fix
-- This migration creates robust functions to handle deletion of users with all their related data

-- First, create a diagnostic function to see what data exists for a user
